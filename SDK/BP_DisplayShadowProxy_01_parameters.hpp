...
public:
	...
	uint8                                         Pad_7919[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_DisplayShadowProxy_01_C_UpdateInstances) == 0x000050, "Wrong size on BP_DisplayShadowProxy_01_C_UpdateInstances");
...
static_assert(offsetof(BP_DisplayShadowProxy_01_C_UpdateInstances, CallFunc_Array_Length_ReturnValue) == 0x000040, "Member 'BP_DisplayShadowProxy_01_C_UpdateInstances::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DisplayShadowProxy_01_C_UpdateInstances, CallFunc_AddInstanceWorldSpace_ReturnValue) == 0x000044, "Member 'BP_DisplayShadowProxy_01_C_UpdateInstances::CallFunc_AddInstanceWorldSpace_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DisplayShadowProxy_01_C_UpdateInstances, CallFunc_Less_IntInt_ReturnValue) == 0x000048, "Member 'BP_DisplayShadowProxy_01_C_UpdateInstances::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
