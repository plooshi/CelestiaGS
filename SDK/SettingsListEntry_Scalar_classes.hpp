...
static_assert(sizeof(USettingsListEntry_Scalar_C) == 0x0002D8, "Wrong size on USettingsListEntry_Scalar_C");
static_assert(offsetof(USettingsListEntry_Scalar_C, UberGraphFrame) == 0x0002B8, "Member 'USettingsListEntry_Scalar_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Scalar_C, OnHover) == 0x0002C0, "Member 'USettingsListEntry_Scalar_C::OnHover' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Scalar_C, DefaultValueLayer) == 0x0002C8, "Member 'USettingsListEntry_Scalar_C::DefaultValueLayer' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Scalar_C, Progress) == 0x0002D0, "Member 'USettingsListEntry_Scalar_C::Progress' has a wrong offset!");
