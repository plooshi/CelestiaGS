...
static_assert(sizeof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C) == 0x0001C0, "Wrong size on UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C");
static_assert(offsetof(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C, ConcurrencySettings) == 0x0001B8, "Member 'UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::ConcurrencySettings' has a wrong offset!");
