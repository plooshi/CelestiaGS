...
static_assert(sizeof(UGA_Athena_RemoveIceFeetOnWater_C) == 0x000A80, "Wrong size on UGA_Athena_RemoveIceFeetOnWater_C");
static_assert(offsetof(UGA_Athena_RemoveIceFeetOnWater_C, UberGraphFrame) == 0x000A78, "Member 'UGA_Athena_RemoveIceFeetOnWater_C::UberGraphFrame' has a wrong offset!");
