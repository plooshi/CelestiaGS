...
public:
	...
	uint8                                         Pad_79AD[0x5];                                     // 0x0003(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79AE[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_object_Variable_1) == 0x000010, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_object_Variable_2) == 0x000018, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_object_Variable_3) == 0x000020, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_object_Variable_3' has a wrong offset!");
...
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_byte_Variable_1) == 0x000038, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_byte_Variable_2) == 0x000039, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, K2Node_Select_Default_1) == 0x00003A, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::K2Node_Select_Default_1' has a wrong offset!");
