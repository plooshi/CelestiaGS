...
void AB_Athena_VendingMachine_C::BlueprintOnBeginInteract(const class AFortPawn* Param_InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted, const ETInteractionType InteractionType)
{
	static class UFunction* Func = nullptr;
...
void AB_Athena_VendingMachine_C::BlueprintOnInteract(const class AFortPawn* Param_InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted)
{
	static class UFunction* Func = nullptr;
...
class FText AB_Athena_VendingMachine_C::BlueprintGetInteractionString(const class AFortPawn* Param_InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted) const
{
	static class UFunction* Func = nullptr;
