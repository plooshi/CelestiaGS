...
public:
	...
	uint8                                         Pad_88E7[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_88E8[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(DriveIn_Projector_C_ExecuteUbergraph_DriveIn_Projector, CallFunc_HasAuthority_ReturnValue) == 0x00002C, "Member 'DriveIn_Projector_C_ExecuteUbergraph_DriveIn_Projector::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
