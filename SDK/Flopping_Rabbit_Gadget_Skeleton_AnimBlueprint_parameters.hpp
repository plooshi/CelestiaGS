...
public:
	...
	uint8                                         Pad_3E56[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_ExecuteUbergraph_Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint, K2Node_Event_DeltaTimeX) == 0x00001C, "Member 'Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_ExecuteUbergraph_Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint::K2Node_Event_DeltaTimeX' has a wrong offset!");
