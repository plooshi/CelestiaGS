...
static_assert(sizeof(AAthena_Prop_Prop_Bear_C) == 0x000BD0, "Wrong size on AAthena_Prop_Prop_Bear_C");
static_assert(offsetof(AAthena_Prop_Prop_Bear_C, UberGraphFrame) == 0x000BC0, "Member 'AAthena_Prop_Prop_Bear_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_Prop_Bear_C, Effects) == 0x000BC8, "Member 'AAthena_Prop_Prop_Bear_C::Effects' has a wrong offset!");
