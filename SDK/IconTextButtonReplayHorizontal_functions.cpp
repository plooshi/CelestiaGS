...
void UIconTextButtonReplayHorizontal_C::SetTabLabelInfo(const struct FFortTabButtonLabelInfo& TabLabelInfo)
{
	...
	Parms.TabLabelInfo = move(TabLabelInfo);
...
void UIconTextButtonReplayHorizontal_C::Set_Icon(const struct FSlateBrush& Param_IconBrush)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_IconBrush = move(Param_IconBrush);
...
void UIconTextButtonReplayHorizontal_C::SetControllerStyle(class UClass* Param_ControllerInputStyle)
{
	static class UFunction* Func = nullptr;
...
void UIconTextButtonReplayHorizontal_C::SetMouseKeyboardStyle(class UClass* Param_ControllerInputStyle)
{
	static class UFunction* Func = nullptr;
...
void UIconTextButtonReplayHorizontal_C::SetContentAlignment(EHorizontalAlignment Param_ContentAlignment)
{
	static class UFunction* Func = nullptr;
