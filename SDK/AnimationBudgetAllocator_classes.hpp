...
{
public:
	uint8                                         Pad_443D[0x20];                                    // 0x0B48(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_443E[0x7];                                     // 0x0B69(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USkeletalMeshComponentBudgeted) == 0x000B70, "Wrong size on USkeletalMeshComponentBudgeted");
