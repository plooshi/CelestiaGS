...
static_assert(alignof(AthenaMatchStatusTextPlayer_C_SetOpacityAndColor) == 0x000008, "Wrong alignment on AthenaMatchStatusTextPlayer_C_SetOpacityAndColor");
static_assert(sizeof(AthenaMatchStatusTextPlayer_C_SetOpacityAndColor) == 0x000028, "Wrong size on AthenaMatchStatusTextPlayer_C_SetOpacityAndColor");
