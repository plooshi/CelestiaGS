...
extern void PEHook(class SDK::UObject* Obj, class SDK::UFunction* Func, void* Params);
namespace SDK
{
...
public:
	...
	static inline auto ProcessEventInternal = ((void (*)(const UObject * Obj, UFunction * Func, void* Params)) (ImageBase + SDK::Offsets::ProcessEvent));
...
{
public:
	uint8                                         Pad_35[0x78];                                      // 0x0028(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool IsSubclassOf() const {
		return IsSubclassOf(T::StaticClass());
	}
...
{
public:
	uint8                                         Pad_3A[0x20];                                      // 0x00B0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	enum class EClassCastFlags                    CastFlags;                                         // 0x00D0(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_3B[0x40];                                      // 0x00D8(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                DefaultObject;                                     // 0x0118(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_3C[0x110];                                     // 0x0120(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_41[0x80];                                      // 0x0230(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_44[0x10];                                      // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_45[0xC8];                                      // 0x0028(0x00C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_46[0x1B8];                                     // 0x00E0(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
