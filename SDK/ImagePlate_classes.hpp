...
public:
	...
	uint8                                         Pad_4797[0x98];                                    // 0x0468(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateComponent) == 0x000500, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000430, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4798[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x000430, "Wrong size on UImagePlateFrustumComponent");
...
public:
	...
	uint8                                         Pad_4799[0x7];                                     // 0x00E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
