...
// Parameters:
// struct FLinearColor                     Param_Color_1                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FLinearColor                     Param_Color_2                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBasicGradientFill_C::Set_Fill(const struct FLinearColor& Param_Color_1, const struct FLinearColor& Param_Color_2, float Rotation__0_Minus_1_)
{
	...
	Parms.Param_Color_1 = move(Param_Color_1);
	Parms.Param_Color_2 = move(Param_Color_2);
...
// Parameters:
// struct FVector2D                        Param_Brush_Size                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBasicGradientFill_C::Set_Brush_Size(const struct FVector2D& Param_Brush_Size)
{
	...
	Parms.Param_Brush_Size = move(Param_Brush_Size);
