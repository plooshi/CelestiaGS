...
{
public:
	uint8                                         Pad_4E04[0x768];                                   // 0x0028(0x0768)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000790, "Wrong size on UAssetRegistryImpl");
