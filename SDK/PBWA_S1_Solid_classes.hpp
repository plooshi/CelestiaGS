...
public:
	...
	uint8                                         Pad_5FEB[0x7];                                     // 0x0CD1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APBWA_S1_Solid_C) == 0x000CE8, "Wrong size on APBWA_S1_Solid_C");
static_assert(offsetof(APBWA_S1_Solid_C, UberGraphFrame) == 0x000CC0, "Member 'APBWA_S1_Solid_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWallChance) == 0x000CC8, "Member 'APBWA_S1_Solid_C::GnomeWallChance' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWallMax) == 0x000CCC, "Member 'APBWA_S1_Solid_C::GnomeWallMax' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, Gnomed) == 0x000CD0, "Member 'APBWA_S1_Solid_C::Gnomed' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeMaterial) == 0x000CD8, "Member 'APBWA_S1_Solid_C::GnomeMaterial' has a wrong offset!");
static_assert(offsetof(APBWA_S1_Solid_C, GnomeWall) == 0x000CE0, "Member 'APBWA_S1_Solid_C::GnomeWall' has a wrong offset!");
