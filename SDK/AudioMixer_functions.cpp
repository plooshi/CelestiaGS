...
void UAudioMixerBlueprintLibrary::GetMagnitudeForFrequencies(const class UObject* WorldContextObject, const TArray<float>& Frequencies, TArray<float>* Magnitudes, class USoundSubmix* SubmixToAnalyze)
{
	...
	Parms.WorldContextObject = WorldContextObject;
	Parms.Frequencies = move(Frequencies);
	...
	if (Magnitudes != nullptr)
		*Magnitudes = move(Parms.Magnitudes);
}
...
void USubmixEffectDynamicsProcessorPreset::SetSettings(const struct FSubmixEffectDynamicsProcessorSettings& Param_Settings)
{
	...
	Parms.Param_Settings = move(Param_Settings);
