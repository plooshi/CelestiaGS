...
static_assert(sizeof(UFortShotTitleScreen_C) == 0x000278, "Wrong size on UFortShotTitleScreen_C");
static_assert(offsetof(UFortShotTitleScreen_C, Image_88) == 0x000270, "Member 'UFortShotTitleScreen_C::Image_88' has a wrong offset!");
