...
static_assert(sizeof(UGA_TrapBuildGeneric_C) == 0x000A88, "Wrong size on UGA_TrapBuildGeneric_C");
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x000A78, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapBuildGeneric_C, PlacedCue) == 0x000A80, "Member 'UGA_TrapBuildGeneric_C::PlacedCue' has a wrong offset!");
