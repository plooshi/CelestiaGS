...
public:
	...
	uint8                                         Pad_79AA[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression) == 0x000070, "Wrong size on XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression");
...
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, K2Node_Event_InDeltaTime) == 0x000058, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, K2Node_ComponentBoundEvent_Level) == 0x00005C, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::K2Node_ComponentBoundEvent_Level' has a wrong offset!");
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_GetTotalScoreEarned_ReturnValue) == 0x000060, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_GetTotalScoreEarned_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000064, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_GetTotalSeasonalXpEarned_ReturnValue) == 0x000068, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_GetTotalSeasonalXpEarned_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x00006C, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_79AB[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_79AC[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
