...
void ABGA_Athena_PurpleMouse_Jumper_C::Launch(const struct FVector& LaunchSource, float Amount)
{
	...
	Parms.LaunchSource = move(LaunchSource);
	Parms.Amount = Amount;
...
void ABGA_Athena_PurpleMouse_Jumper_C::FilterByLOS(TArray<class AActor*>& _Array, TArray<class AActor*>* _Result)
{
	...
	Parms._Array = move(_Array);

	UObject::ProcessEvent(Func, &Parms);

	_Array = move(Parms._Array);

	if (_Result != nullptr)
		*_Result = move(Parms._Result);
}
...
void ABGA_Athena_PurpleMouse_Jumper_C::Init(const struct FVector& Param_GravHitNormal)
{
	...
	Parms.Param_GravHitNormal = move(Param_GravHitNormal);
