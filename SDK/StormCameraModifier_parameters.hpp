...
public:
	...
	uint8                                         Pad_5A2C[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(StormCameraModifier_C_BlueprintModifyPostProcess) == 0x000A90, "Wrong size on StormCameraModifier_C_BlueprintModifyPostProcess");
...
static_assert(offsetof(StormCameraModifier_C_BlueprintModifyPostProcess, K2Node_MakeStruct_PostProcessSettings) == 0x000550, "Member 'StormCameraModifier_C_BlueprintModifyPostProcess::K2Node_MakeStruct_PostProcessSettings' has a wrong offset!");
