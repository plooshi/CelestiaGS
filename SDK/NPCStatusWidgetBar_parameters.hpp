...
static_assert(sizeof(NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar) == 0x000018, "Wrong size on NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar");
...
static_assert(offsetof(NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000008, "Member 'NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar, CallFunc_K2_GetScalarParameterValue_ReturnValue) == 0x000010, "Member 'NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar::CallFunc_K2_GetScalarParameterValue_ReturnValue' has a wrong offset!");
