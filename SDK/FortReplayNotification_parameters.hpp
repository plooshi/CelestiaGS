...
public:
	...
	uint8                                         Pad_7D8F[0x3];                                     // 0x0051(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class FText& NotificationText, struct FNotificationUISettings& NotificationSettings)> K2Node_CreateDelegate_OutputDelegate;              // 0x0054(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification) == 0x000078, "Wrong size on FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification");
...
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_Event_MyGeometry) == 0x000004, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_Event_InDeltaTime) == 0x00003C, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, CallFunc_GetPlayerController_ReturnValue) == 0x000040, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_DynamicCast_AsFort_Player_Controller_Spectating) == 0x000048, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_DynamicCast_AsFort_Player_Controller_Spectating' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_CreateDelegate_OutputDelegate) == 0x000054, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_CreateDelegate_OutputDelegate_1) == 0x000064, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification, K2Node_CustomEvent_bShouldShowNotifications) == 0x000074, "Member 'FortReplayNotification_C_ExecuteUbergraph_FortReplayNotification::K2Node_CustomEvent_bShouldShowNotifications' has a wrong offset!");
...
static_assert(alignof(FortReplayNotification_C_Tick) == 0x000004, "Wrong alignment on FortReplayNotification_C_Tick");
static_assert(sizeof(FortReplayNotification_C_Tick) == 0x00003C, "Wrong size on FortReplayNotification_C_Tick");
...
static_assert(offsetof(FortReplayNotification_C_Tick, InDeltaTime) == 0x000038, "Member 'FortReplayNotification_C_Tick::InDeltaTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_7D90[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7D91[0x3];                                     // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7D92[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7D93[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7D94[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetText_ReturnValue;                      // 0x0008(0x0018)()
	bool                                          CallFunc_IsVisibilityNotification_IsVisibilityNotification; // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                         Pad_7D95[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7D96[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7D97[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7D98[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7D99[0x5];                                     // 0x0023(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
