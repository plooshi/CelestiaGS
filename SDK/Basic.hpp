...
*	- THe 'GWorld' offset is not used by the SDK, it's just there for "decoration", use the provided 'UWorld::Get()' function instead
*/
namespace Offsets
{
...
class UClass* StaticBPGeneratedClassImpl()
{
	...
	if constexpr (bIsFullName)
	{
		return StaticBPGeneratedClassByFullName(Name, ClassIdx);
	}
	else /* Default, use just the name to find an object*/
	{
		return StaticBPGeneratedClassByName(Name, ClassIdx);
	}
}
...
public:
	...
	xwstring ToWString() const
	{
		xwstring OutputString = GetRawWString();
...
public:
	UEType* Get() const
	{
		return static_cast<UEType*>(InternalGet((FSoftObjectPtr *) this, UEType::StaticClass()));
	}
	UEType* operator->() const
	{
		return Get();
...
public:
	UClass *Get() const
	{
		return static_cast<UClass*>(InternalGet((FSoftObjectPtr *) this, UClass::StaticClass()));
	}
...
public:
	...
	InterfaceType*                                InterfacePointer;                                  // 0x0008(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	InterfaceType* GetInterfaceRef() const
	{
		return InterfacePointer;
	}
	
};
static_assert(alignof(FScriptInterface<void>) == 0x000008, "Wrong alignment on FScriptInterface");
static_assert(sizeof(FScriptInterface<void>) == 0x000010, "Wrong size on FScriptInterface");
static_assert(offsetof(FScriptInterface<void>, ObjectPointer) == 0x000000, "Member 'FScriptInterface::ObjectPointer' has a wrong offset!");
static_assert(offsetof(FScriptInterface<void>, InterfacePointer) == 0x000008, "Member 'FScriptInterface::InterfacePointer' has a wrong offset!");

// Predefined struct TScriptInterface
// 0x0000 (0x0010 - 0x0010)
template<class InterfaceType>
class TScriptInterface final : public FScriptInterface<InterfaceType>
{
};
