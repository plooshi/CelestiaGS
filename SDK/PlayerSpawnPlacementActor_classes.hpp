...
static_assert(sizeof(APlayerSpawnPlacementActor_C) == 0x000630, "Wrong size on APlayerSpawnPlacementActor_C");
static_assert(offsetof(APlayerSpawnPlacementActor_C, Arrow) == 0x000628, "Member 'APlayerSpawnPlacementActor_C::Arrow' has a wrong offset!");
