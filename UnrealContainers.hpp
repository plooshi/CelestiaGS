...
{	
	...
	{
	public:
		static inline auto InternalRealloc = (void* (*)(void*, __int64, unsigned int)) Offsets::Realloc;
...
#pragma warning(suppress: 4244)
	...
	*/
	...
	template< class ObjectType, ESPMode InMode = ESPMode::ThreadSafe >
	class TSharedPtr
	{
	public:
		...
		FORCEINLINE TSharedPtr(ObjectType* InObjType = nullptr)
			: Object(nullptr)
	...
	template< class ObjectType >
	[[nodiscard]] FORCEINLINE TRawPtrProxy< ObjectType > MakeShareable(ObjectType* InObject)
	{
		return TRawPtrProxy< ObjectType >(InObject);
	}
}
