...
public:
	...
	uint8                                         Pad_54CC[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TDelegate<void(const struct FGameplayTagContainer& FailedReason, class FText& FailureText)> K2Node_CreateDelegate_OutputDelegate;              // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget, K2Node_CustomEvent_FailedReason) == 0x000020, "Member 'ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget::K2Node_CustomEvent_FailedReason' has a wrong offset!");
static_assert(offsetof(ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget, K2Node_CustomEvent_FailureText) == 0x000040, "Member 'ReticleStatusWidget_C_ExecuteUbergraph_ReticleStatusWidget::K2Node_CustomEvent_FailureText' has a wrong offset!");
