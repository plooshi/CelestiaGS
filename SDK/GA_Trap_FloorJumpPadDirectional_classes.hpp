...
static_assert(sizeof(UGA_Trap_FloorJumpPadDirectional_C) == 0x000AF8, "Wrong size on UGA_Trap_FloorJumpPadDirectional_C");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, UberGraphFrame_GA_Trap_FloorJumpPadDirectional_C) == 0x000AA8, "Member 'UGA_Trap_FloorJumpPadDirectional_C::UberGraphFrame_GA_Trap_FloorJumpPadDirectional_C' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, LaunchedPlayer) == 0x000AB0, "Member 'UGA_Trap_FloorJumpPadDirectional_C::LaunchedPlayer' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, TC_LaunchTag) == 0x000AB8, "Member 'UGA_Trap_FloorJumpPadDirectional_C::TC_LaunchTag' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, OverlappingTargets) == 0x000AC0, "Member 'UGA_Trap_FloorJumpPadDirectional_C::OverlappingTargets' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, TargetData) == 0x000AD0, "Member 'UGA_Trap_FloorJumpPadDirectional_C::TargetData' has a wrong offset!");
