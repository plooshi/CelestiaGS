...
static_assert(sizeof(UGA_AthenaEnterVehicle_C) == 0x000A80, "Wrong size on UGA_AthenaEnterVehicle_C");
static_assert(offsetof(UGA_AthenaEnterVehicle_C, UberGraphFrame) == 0x000A78, "Member 'UGA_AthenaEnterVehicle_C::UberGraphFrame' has a wrong offset!");
