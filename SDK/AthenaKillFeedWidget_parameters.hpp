...
public:
	...
	uint8                                         Pad_6DC6[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, bAnyActiveContent) == 0x000000, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::bAnyActiveContent' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, Temp_int_Array_Index_Variable) == 0x000004, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, Temp_int_Loop_Counter_Variable) == 0x000008, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Add_IntInt_ReturnValue) == 0x00000C, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Array_Get_Item_1) == 0x000028, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Array_Get_Item_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_6DC8[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6DC9[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AthenaKillFeedWidget_C_ExecuteUbergraph_AthenaKillFeedWidget, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'AthenaKillFeedWidget_C_ExecuteUbergraph_AthenaKillFeedWidget::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaKillFeedWidget_C_ExecuteUbergraph_AthenaKillFeedWidget, K2Node_CreateDelegate_OutputDelegate) == 0x00001C, "Member 'AthenaKillFeedWidget_C_ExecuteUbergraph_AthenaKillFeedWidget::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
