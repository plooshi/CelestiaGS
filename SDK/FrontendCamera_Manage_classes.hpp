...
{
public:
	uint8                                         Pad_6F8B[0x8];                                     // 0x07C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AFrontendCamera_Manage_C, UberGraphFrame) == 0x0007D0, "Member 'AFrontendCamera_Manage_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Manage_C, LoginCamera_0) == 0x0007D8, "Member 'AFrontendCamera_Manage_C::LoginCamera_0' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Manage_C, ChangeTimeOfDayOnActivate) == 0x0007E0, "Member 'AFrontendCamera_Manage_C::ChangeTimeOfDayOnActivate' has a wrong offset!");
