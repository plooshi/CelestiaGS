...
static_assert(sizeof(BuoyancyComponent_OnPontoonEnteredWater) == 0x000130, "Wrong size on BuoyancyComponent_OnPontoonEnteredWater");
...
static_assert(sizeof(BuoyancyComponent_OnPontoonExitedWater) == 0x000130, "Wrong size on BuoyancyComponent_OnPontoonExitedWater");
...
public:
	...
	uint8                                         Pad_3F9A[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
