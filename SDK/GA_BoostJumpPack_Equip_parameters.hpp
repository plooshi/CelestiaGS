...
public:
	...
	uint8                                         Pad_6008[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility) == 0x0000B8, "Wrong size on GA_BoostJumpPack_Equip_C_K2_CanActivateAbility");
...
static_assert(offsetof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility, RelevantTags) == 0x000048, "Member 'GA_BoostJumpPack_Equip_C_K2_CanActivateAbility::RelevantTags' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility, ReturnValue) == 0x000068, "Member 'GA_BoostJumpPack_Equip_C_K2_CanActivateAbility::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility, LocalPlayerPawn) == 0x000070, "Member 'GA_BoostJumpPack_Equip_C_K2_CanActivateAbility::LocalPlayerPawn' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility, ErrorReasonGamepad) == 0x000078, "Member 'GA_BoostJumpPack_Equip_C_K2_CanActivateAbility::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(GA_BoostJumpPack_Equip_C_K2_CanActivateAbility, ErrorReason) == 0x000098, "Member 'GA_BoostJumpPack_Equip_C_K2_CanActivateAbility::ErrorReason' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_600A[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_600B[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
