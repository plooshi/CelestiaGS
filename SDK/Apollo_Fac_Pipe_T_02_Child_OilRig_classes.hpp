...
static_assert(sizeof(AApollo_Fac_Pipe_T_02_Child_OilRig_C) == 0x000BD0, "Wrong size on AApollo_Fac_Pipe_T_02_Child_OilRig_C");
static_assert(offsetof(AApollo_Fac_Pipe_T_02_Child_OilRig_C, UberGraphFrame) == 0x000BC0, "Member 'AApollo_Fac_Pipe_T_02_Child_OilRig_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AApollo_Fac_Pipe_T_02_Child_OilRig_C, Is_Oil_Dripping) == 0x000BC8, "Member 'AApollo_Fac_Pipe_T_02_Child_OilRig_C::Is_Oil_Dripping' has a wrong offset!");
