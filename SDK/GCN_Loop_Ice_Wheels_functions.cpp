...
// Parameters:
// TArray<class FName>                     Sockets                                                (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
...
// TArray<class UParticleSystemComponent*> SpawnedEmitters1                                       (Parm, OutParm, ContainsInstancedReference, HasGetValueTypeHash)
...
void AGCN_Loop_Ice_Wheels_C::SpawnEmittersAttachedToWheels(TArray<class FName>& Sockets, class USceneComponent* AttachToComponent, bool NoOffsets, class UParticleSystem* EmitterTemplate, float ScaleMult, TArray<class UParticleSystemComponent*>* SpawnedEmitters1)
{
	...
	Sockets = move(Parms.Sockets);

	if (SpawnedEmitters1 != nullptr)
		*SpawnedEmitters1 = move(Parms.SpawnedEmitters1);
}
