...
static_assert(sizeof(VehiclePassengerLayerAnimBP_C_ExecuteUbergraph_VehiclePassengerLayerAnimBP) == 0x000004, "Wrong size on VehiclePassengerLayerAnimBP_C_ExecuteUbergraph_VehiclePassengerLayerAnimBP");
...
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'VehiclePassengerLayerAnimBP_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
static_assert(sizeof(VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride) == 0x0000B0, "Wrong size on VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride");
...
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride, Param_TurnInPlace) == 0x000020, "Member 'VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride::Param_TurnInPlace' has a wrong offset!");
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride, InPoseUpperAndLowerBodyRemoveRoot) == 0x000090, "Member 'VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride::InPoseUpperAndLowerBodyRemoveRoot' has a wrong offset!");
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride, Param_VehicleSplitBodyOverride) == 0x0000A0, "Member 'VehiclePassengerLayerAnimBP_C_VehicleSplitBodyOverride::Param_VehicleSplitBodyOverride' has a wrong offset!");
...
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_VehicleLowerBodyOverride, Param_VehicleLowerBodyOverride) == 0x000020, "Member 'VehiclePassengerLayerAnimBP_C_VehicleLowerBodyOverride::Param_VehicleLowerBodyOverride' has a wrong offset!");
...
static_assert(offsetof(VehiclePassengerLayerAnimBP_C_VehicleFullBodyOverride, Param_VehicleFullBodyOverride) == 0x000020, "Member 'VehiclePassengerLayerAnimBP_C_VehicleFullBodyOverride::Param_VehicleFullBodyOverride' has a wrong offset!");
