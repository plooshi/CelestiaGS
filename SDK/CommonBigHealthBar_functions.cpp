...
void UCommonBigHealthBar_C::SetColors(const struct FLinearColor& ColorA, const struct FLinearColor& ColorB, const struct FLinearColor& BevelColor, const struct FLinearColor& BaseplateColor)
{
	...
	Parms.ColorA = move(ColorA);
	Parms.ColorB = move(ColorB);
	Parms.BevelColor = move(BevelColor);
	Parms.BaseplateColor = move(BaseplateColor);
...
void UCommonBigHealthBar_C::SetSwitcherTextIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
