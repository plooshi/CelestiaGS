...
static_assert(sizeof(UGA_AthenaExitVehicle_C) == 0x000A80, "Wrong size on UGA_AthenaExitVehicle_C");
static_assert(offsetof(UGA_AthenaExitVehicle_C, UberGraphFrame) == 0x000A78, "Member 'UGA_AthenaExitVehicle_C::UberGraphFrame' has a wrong offset!");
