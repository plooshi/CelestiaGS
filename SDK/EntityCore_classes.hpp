...
{
public:
	uint8                                         Pad_4993[0x30];                                    // 0x0028(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_4994[0x8];                                     // 0x0058(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4995[0x1F];                                    // 0x0059(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_4996[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_4997[0xB8];                                    // 0x0030(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEntityCoreSubsystem) == 0x000148, "Wrong size on UEntityCoreSubsystem");
...
{
public:
	uint8                                         Pad_4998[0x38];                                    // 0x0078(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
