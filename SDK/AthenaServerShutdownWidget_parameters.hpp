...
public:
	...
	uint8                                         Pad_789A[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AthenaServerShutdownWidget_C_SetCountdownText) == 0x000070, "Wrong size on AthenaServerShutdownWidget_C_SetCountdownText");
...
static_assert(offsetof(AthenaServerShutdownWidget_C_SetCountdownText, K2Node_MakeStruct_FormatArgumentData) == 0x000008, "Member 'AthenaServerShutdownWidget_C_SetCountdownText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(AthenaServerShutdownWidget_C_SetCountdownText, K2Node_MakeArray_Array) == 0x000048, "Member 'AthenaServerShutdownWidget_C_SetCountdownText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(AthenaServerShutdownWidget_C_SetCountdownText, CallFunc_Format_ReturnValue) == 0x000058, "Member 'AthenaServerShutdownWidget_C_SetCountdownText::CallFunc_Format_ReturnValue' has a wrong offset!");
