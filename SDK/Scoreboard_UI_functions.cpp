...
void UScoreboard_UI_C::MakePlayerScoreboardRow(const struct FMinigameScoreboardPlayerRow& PlayerRow, int32 PlayerIndex, bool ShowWins, int32 NumPlayers, int32 Standing, class UScoreboard_UI_Row_C** ScoreboardRow)
{
	...
	Parms.PlayerRow = move(PlayerRow);
...
void UScoreboard_UI_C::HandleScoreboardColumnsData(TArray<class FText>& ScoreboardStatNames, bool bTeamGame, bool bDisplayingWins)
{
	...
	Parms.ScoreboardStatNames = move(ScoreboardStatNames);
	Parms.bTeamGame = bTeamGame;
	Parms.bDisplayingWins = bDisplayingWins;

	UObject::ProcessEvent(Func, &Parms);

	ScoreboardStatNames = move(Parms.ScoreboardStatNames);
}
...
// bool                                    Param_IsRoundsGame                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
class UScoreboard_Team_Widget_C* UScoreboard_UI_C::MakeTeamScoreboardRow(const struct FMinigameScoreboardBucketRow& MinigameScoreboardBucketRow, bool Param_IsRoundsGame)
{
	static class UFunction* Func = nullptr;
	...
	Parms.MinigameScoreboardBucketRow = move(MinigameScoreboardBucketRow);
	Parms.Param_IsRoundsGame = Param_IsRoundsGame;
...
void UScoreboard_UI_C::ShowWinnerDisplay(const class FText& Winner_Name, const class FText& Win_Description, bool GameHasWinner)
{
	...
	Parms.Winner_Name = move(Winner_Name);
	Parms.Win_Description = move(Win_Description);
