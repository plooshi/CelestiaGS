...
void UScoreboard_UI_Row_C::FillStatData(TArray<struct FMinigameScoreboardValue>& StatValues)
{
	...
	Parms.StatValues = move(StatValues);

	UObject::ProcessEvent(Func, &Parms);

	StatValues = move(Parms.StatValues);
}
...
// Parameters:
// struct FMinigameScoreboardPlayerRow     Param_PlayerBucketData                                 (BlueprintVisible, BlueprintReadOnly, Parm)

void UScoreboard_UI_Row_C::UpdatePlayerData(const struct FMinigameScoreboardPlayerRow& Param_PlayerBucketData)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_PlayerBucketData = move(Param_PlayerBucketData);
