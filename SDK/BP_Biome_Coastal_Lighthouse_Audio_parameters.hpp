...
public:
	...
	uint8                                         Pad_7820[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7821[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7822[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, EAthenaGamePhaseStep GamePhaseStep)> K2Node_CreateDelegate_OutputDelegate;              // 0x0034(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(BP_Biome_Coastal_Lighthouse_Audio_C_ExecuteUbergraph_BP_Biome_Coastal_Lighthouse_Audio, CallFunc_IsPlaying_ReturnValue) == 0x000044, "Member 'BP_Biome_Coastal_Lighthouse_Audio_C_ExecuteUbergraph_BP_Biome_Coastal_Lighthouse_Audio::CallFunc_IsPlaying_ReturnValue' has a wrong offset!");
