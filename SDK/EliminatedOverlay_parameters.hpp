...
public:
	...
	uint8                                         Pad_511B[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_511C[0x3];                                     // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_511D[0x4];                                     // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_511E[0x1];                                     // 0x007B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(EliminatedOverlay_C_SetPlaceTextFont_TEMP) == 0x000118, "Wrong size on EliminatedOverlay_C_SetPlaceTextFont_TEMP");
...
static_assert(offsetof(EliminatedOverlay_C_SetPlaceTextFont_TEMP, K2Node_Select_Default_3) == 0x0000C0, "Member 'EliminatedOverlay_C_SetPlaceTextFont_TEMP::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_SetPlaceTextFont_TEMP, K2Node_MakeStruct_SlateFontInfo) == 0x0000C8, "Member 'EliminatedOverlay_C_SetPlaceTextFont_TEMP::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5120[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TDelegate<void(bool bSpectatorStreaming)>     K2Node_CreateDelegate_OutputDelegate_4;            // 0x0058(0x0010)(ZeroConstructor, NoDestructor)
	...
	uint8                                         Pad_5121[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FText>                           K2Node_MakeArray_Array;                            // 0x0078(0x0010)(ReferenceParm, HasGetValueTypeHash)
	...
	uint8                                         Pad_5122[0x4];                                     // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay) == 0x0000F8, "Wrong size on EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay");
...
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_CreateDelegate_OutputDelegate_1) == 0x000014, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_CreateDelegate_OutputDelegate_2) == 0x000024, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_CreateDelegate_OutputDelegate_3) == 0x000034, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000048, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_GetOwningPlayer_ReturnValue) == 0x000050, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_CreateDelegate_OutputDelegate_4) == 0x000058, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_DynamicCast_AsFort_Player_Controller_Athena) == 0x000068, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_DynamicCast_AsFort_Player_Controller_Athena' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_DynamicCast_bSuccess) == 0x000070, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_MakeArray_Array) == 0x000078, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue) == 0x000088, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, K2Node_Event_BannerInfo) == 0x000090, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::K2Node_Event_BannerInfo' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_1) == 0x0000B8, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_2) == 0x0000C0, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_3) == 0x0000C8, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_4) == 0x0000D0, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_5) == 0x0000D8, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_GetEndTime_ReturnValue) == 0x0000E0, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_GetEndTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_6) == 0x0000E8, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay, CallFunc_PlayAnimation_ReturnValue_7) == 0x0000F0, "Member 'EliminatedOverlay_C_ExecuteUbergraph_EliminatedOverlay::CallFunc_PlayAnimation_ReturnValue_7' has a wrong offset!");
