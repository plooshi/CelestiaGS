...
{
public:
	uint8                                         Pad_4F9F[0x8];                                     // 0x07C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ASpecialEventsCamera_Blueprint_C) == 0x0007E0, "Wrong size on ASpecialEventsCamera_Blueprint_C");
static_assert(offsetof(ASpecialEventsCamera_Blueprint_C, UberGraphFrame) == 0x0007D0, "Member 'ASpecialEventsCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
